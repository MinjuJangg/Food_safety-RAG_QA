...
df = pd.read_excel(file_path, sheet_name=f"{year}", usecols=["제목", "내용"])
...
kiwi_retriever = None
try:
    with open(f"/home/food/people/minju/embedding/bm25/bm25_{year}.pkl", "rb") as f:
...
# 3-2) FAISS + 임베딩 (LaBSE)
with open(f"/home/food/people/minju/embedding/labse2/embeddings_{year}.pkl", "rb") as f:
...
if __name__ == "__main__":
    ...
    input_json = f"/home/food/people/minju/make_data/final_data/qa_results_{year}.json"
    output_csv = f"./hybrid/{year}2.csv"
